...
public abstract class FormSpec implements Serializable {
    ...
    private Size parseAtomicSize(String token) {
        ...
        if (trimmedToken.startsWith("'") && trimmedToken.endsWith("'")) {
            ...
            ComponentSize componentSize = ComponentSize.valueOf(trimmedToken);
    ...
    final int maximumSize(Container container, List components, Measure minMeasure, Measure prefMeasure, Measure defaultMeasure) {
